...
if __name__ == '__main__':
    ...
    parser.add_argument('--first_peak_number', type=int, default=1)
    args = parser.parse_args()

    my_scan = software_threshold_scan.adc_scan(args.input_files, args.led_file, pcb_half=None)
    ...
    my_scan.dac_to_adc_and_pe(force_first_peak_number=args.first_peak_number)