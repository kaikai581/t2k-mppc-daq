...
def process_all_channels(infpn):
    ...
    # results container
    outfpn = os.path.join(out_dir, '{}_total_gain.txt'.format(file_date))
    ...
    for feb_num in feb_nums:
        for ch_num in ch_nums:
            ...
            gain[bias_volt][ch_name] = find_gain(df, feb_num, ch_num)
    # process_one_channel(df, 0, 5)
    # process_one_channel(df, 0, 6)
    # process_one_channel(df, 0, 7)
