#!/usr/bin/env python
'''
This script compares the MPPC gain measurements of the LSU MPPC-PCB from LSU and UTotyo.
'''
...
if __name__ == '__main__':
    ...
    for temp in [20, 25]:
        ...
        fig.savefig(os.path.join(out_dir, 'mppc_gain_lsu_pcb_lsu_meas_{}C.png'.format(temp)), bbox_inches='tight')
        ...
        the_table.set_fontsize(15)
        fig.tight_layout()
        fig.savefig(os.path.join(out_dir, 'mppc_gain_lsu_pcb_utokyo_meas_{}C.png').format(temp))

        # UTokyo Vbd and LSU Vbd
        fig, ax_lsu20_utokyo_20 = plt.subplots()
        ...
        fig.tight_layout()
        fig.savefig(os.path.join(out_dir, 'mppc_gain_lsu_pcb_lsu_meas_utokyo_meas_{}C.png'.format(temp)))
        ...
        fig.tight_layout()
        fig.savefig(os.path.join(out_dir, 'mppc_gain_lsu_pcb_lsu_meas_diff_utokyo_meas_{}C.png'.format(temp)))
        ...
        the_table.set_fontsize(15)
        fig.tight_layout()
        fig.savefig(os.path.join(out_dir, 'mppc_gain_lsu_pcb_lsu_meas_ratio_utokyo_meas_{}C.png'.format(temp)))
